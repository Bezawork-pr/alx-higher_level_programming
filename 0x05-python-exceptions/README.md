...
### 8. Safe function
* [101-safe_function.py](https://github.com/Bezawork-pr/alx-higher_level_programming/blob/master/0x05-python-exceptions/101-safe_function.py): A function that executes a function safely.
    * Assumption:
        * fct will be always a pointer to a function
    * Returns the result of the function.
    * Otherwise, returns None if something happens during the function and prints in stderr the error precede by Exception:
<pre>
Constraints:  Have to use try: / except:
</pre>
### 9. ByteCode -> Python #4
